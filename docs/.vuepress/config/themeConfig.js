...
const { lastIndexOf } = require('./head');
...
module.exports = {
  ...
  indexImg: {
    ...
    desc: ["一个90后程序员，终身学习者。 —— 来自 lakeiedward", "故事由我书写，旅程由你见证，传奇由她聆听 —— 来自 lakeiedward", "这一生波澜壮阔或是不惊都没问题 —— 来自 Weibw"],  // 多个描述，如果填写则覆盖 config.js 的 description，不填写默认读取 config.js 的 description，descFadeIn 为 true 生效
